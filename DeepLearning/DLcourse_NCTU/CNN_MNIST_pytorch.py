...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv1_1 = nn.Conv2d(12, 18, kernel_size=(3,3),stride=1, padding=1)
        self.conv1_2 = nn.Conv2d(18, 24, kernel_size=(3,3),stride=1, padding=1)
        self.conv2 = nn.Conv2d(24, 32, kernel_size=(5,5),stride=1, padding=0)
